                                ...
                                <div class="step-form">
                                    ...
                                    <div class="form-container extra-label">
                                        ...
                                        <div class="input-container">
                                            <input type="text" name="name" placeholder="<?php echo esc_html($nameCardPlaceholder); ?>" value="<?php echo esc_html($name_billing) ?>" style="margin-left: -7px; text-align: left;">
                                        </div>
                                    </div>
                                            ...
                                            <div class="card-jss" data-icon-colour="#158CBA">
                                                <div class="card-number2-wrapper">
                                                    <input class="card-number2" id="the-card-number-element"
                                                        ...
                                                        autocapitalize="off" style=" margin-left: -7px; text-align: left; padding-right: 20px !important;">
                                                </div>
                                            </div>
                                    ...
                                    <div class="dosCampos">
                                        ...
                                        <div class="form-container dateYex fecha-exp">
                                            ...
                                            <div class="input-expiry-container" style="display: flex !important; gap: 13px !important; flex-wrap: nowrap !important; align-items: center !important; width:50% !important;">
                                                <input type="number" name="month" id="month-value" placeholder=" MM" maxlength="2" autocomplete="off" data-epayco="card[exp_month]" required style="width: 50% !important; flex: 0 0 calc(50% - 9.5px) !important; text-align: left;     margin-left: 3px;">
