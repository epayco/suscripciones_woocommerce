...
<div id="lang_epayco" hidden="true">'.$lang.'</div>
 <div class="loader-container">
    ...
    background-image: url(https://369969691f476073508a-60bf0867add971908d4f26a64519c2aa.ssl.cf5.rackcdn.com/btns/epayco/boton_de_cobro_epayco4.png );
                  ...
                  <div class="bar-option hidden-print">
                      <div class="dropdown select-pais pointer">
                        <a class="dropdown-toggle blockd" type="button" data-toggle="dropdown">
                            <div class="flag flag-icon-background flag-icon-co" data-toggle="dropdown"></div>
                              Colombia
  ...
  <div class="wc scroll-content">
      ...
      <div class="menu-select">
          ...
          <div class="card-js" data-icon-colour="#158CBA">
            <input class="name" id="the-card-name-element" data-epayco="card[name]" required '.$name_billing.'>
  ...
  <script src="https://kit.fontawesome.com/fc569eac4d.js" crossorigin="anonymous"></script>
        ...
        function ePaycoSub_successful_request($validationData)
        {
            ...
            if($_REQUEST["confirmation"]){
                $data = $subscription->subscription_epayco_confirm($_REQUEST);
                }else{
